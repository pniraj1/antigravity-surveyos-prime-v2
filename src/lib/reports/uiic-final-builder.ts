...
// ─── Surveyor Header (matches benchmark getSurveyorHeader) ────────────────────

function getSurveyorHeader(profile: SurveyorProfile | null): string {
  ...
  return `<div style="border-bottom:1.2pt solid #000;padding-bottom:5px;margin-bottom:6px;">
...
function getSigBlock(profile: SurveyorProfile | null): string {
  const name = profile?.name || 'SURVEYOR NAME';
  return `<div style="display:flex;justify-content:flex-end;align-items:flex-end;margin-top:14px;gap:8px;">
    <div style="text-align:center;">
