...
// If API key is ever exposed, rotate it immediately in Firebase Console: https://console.firebase.google.com/project/surveyos-v2-antigravity-in/settings/apikeys
